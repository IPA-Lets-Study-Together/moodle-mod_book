...
/**
 * bookverification_verifier chapter verified event
 *
...
/**
 * bookverification_verifier chapter verified event class
 *
 * @package    bookverification_verifier
 * @copyright  2014 Ivana Skelic, Hrvoje Golcic 
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class chapter_verified extends \core\event\base {
    ...
    public static function get_name() {
    	return get_string('event_chapter_verified', 'bookverification_verifier');
    }
